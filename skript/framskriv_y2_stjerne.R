...
## ============================================================================
## 5. Predikér Y_2* med hovedmodell
## ============================================================================
...
hovedmodell <- readRDS(file.path(utmappe, "modell_y2s_hovedmodell.rds"))
...
framskrevet_y2s_raa <- framskriv_y2s(hovedmodell, framtidsdata)
